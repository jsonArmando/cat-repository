...
describe('GatosController', () => {
    ...
    beforeEach(() => {
        // Limpiar mocks pre-test
        (CatService as unknown as jest.Mock).mockClear();

        // Instanciar el servicio (que ahora es un mock)
    ...
    describe('getAllBreeds', () => {
        it('should return a list of breeds', async () => {
            ...
            (mockCatService.getAllBreeds as jest.Mock).mockResolvedValue(mockBreeds);
    ...
    describe('getBreedById', () => {
        it('should return a breed if found', async () => {
            ...
            (mockCatService.getBreedById as jest.Mock).mockResolvedValue(mockBreed);
        ...
        it('should return 404 if breed not found', async () => {
            ...
            (mockCatService.getBreedById as jest.Mock).mockResolvedValue(null);
    ...
    describe('searchBreeds', () => {
        it('should return breeds matching query', async () => {
            req.query = { q: 'ben' };
            const mockBreeds: CatBreed[] = [{ id: 'beng', name: 'Bengal', origin: 'US', temperament: '', description: '' }];
            (mockCatService.searchBreeds as jest.Mock).mockResolvedValue(mockBreeds);
